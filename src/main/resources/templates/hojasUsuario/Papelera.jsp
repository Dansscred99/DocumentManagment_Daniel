...
<header class="header">
    <div class="header-left">
        <button class="menu-btn" onclick="window.location.href='../Usuario.jsp'">←</button>
        <h1>Papelera</h1>
    </div>
...
<div class="container">
    <aside class="sidebar">
        <nav>
            <a href="../Usuario.jsp">Dashboard</a>
            <a href="../hojasUsuario/MisDocumentos.jsp">Mis Documentos</a>
             <a href="../hojasUsuario/Enviados.jsp">Enviados</a>
             <a href="../hojasUsuario/Papelera.jsp" class="active">Papelera</a>
        </nav>
    </aside>
